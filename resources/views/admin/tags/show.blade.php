    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card-header mb-3 d-flex justify-content-between">
                <form action="{{route('tags.update', $tag->id)}}" method="POST" class="w-50">
                    @csrf
                    @method('PUT')
                ...
                <div class="d-flex">
                    <a href="{{route('tags.index')}}" class="mx-2"><button type="button" class="btn btn-primary">Indietro</button></a>
